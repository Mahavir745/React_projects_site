...
const Project = ({project,darkMode}) => {
  return (
    <div className={`w-[400px] h-[500px] border rounded-xl bg-gray-100 ${darkMode && "bg-gray-900"}`}>
      <div className='p-2 flex flex-col justify-center gap-2'>
        ...
        <iframe src={`${project.project_img}`} width="380" height="180" allow="autoplay" className='rounded-2xl'></iframe>
